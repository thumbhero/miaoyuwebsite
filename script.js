...
const translations = {
  ...
  en: {
    ...
    about_p4: 'Fluent in Taiwanese Mandarin, German, and English, Miaoyu bridges musical cultures across East Asia and Central Europe — available for orchestral engagements, chamber music collaborations, and concert bookings internationally.',
    instr_violin: 'Violin',
    instr_viola:  'Viola',
    instr_piano:  'Piano',
  ...
  de: {
    ...
    about_p4: 'Fließend in Mandarin, Deutsch und Englisch verbindet Miaoyu musikalische Kulturen aus Ostasien und Mitteleuropa — verfügbar für Orchesterengagements, Kammermusikkooperationen und Konzertbuchungen weltweit.',
